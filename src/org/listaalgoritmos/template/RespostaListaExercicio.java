...
public class RespostaListaExercicio {
	...
	public static void main(String[] args) {
		System.out.println(calcularImc(58f, 1.80f));
		System.out.println(calcularAreaTrapezio(8f, 15f, 3f));
		System.out.println(maiorEntreDoisInteiros(3, 8));
		System.out.println(verificarParImpar(6));
		float[] notas = { 1, 3, 8 };
		System.out.println(calcularMediaNotas(notas));
		 imprimirArrayInverso(new int[] { 1, 5, 8, 9 });
		imprimirElementosPrimos(new int[] { 5, 3, 8, 7 });
		imprimirElementosImpares(new int[] { 2, 4, 9, 3, 7 });
		imprimirElementosPares(new int[] { 5, 9, 2, 8 });
		imprimirMaiorMenorElemento(new int[] { 5, 9});
		System.out.println(calcularMediaAritmetica(new int[] { 5, 2, 1 }));
	}
